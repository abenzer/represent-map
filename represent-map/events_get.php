...
function getEventbriteEvents($eb_keywords, $eb_city, $eb_proximity) {
  ...
  $xml_url = "https://www.eventbrite.com/xml/event_search?...&within=".$eb_proximity."&within_unit=M&keywords=".$eb_keywords."&city=".$eb_city."&date=This+month&app_key=".$eb_app_key;
  echo $xml_url."<br />";
