...
3. Open /include/db_example.php with your text editor. Enter your MySQL credentials in there. Also, add a password for the admin panel. Rename the file to "db.php".
